...
const PostImages = ({ boosted = false, images = ["/images/post-image-min.jpg"] }) => {

    return(
        <div className="__post --images column">
            ...
            <div className="white-space-16"></div>
            <div className="__images row-responsive">
                <div className="__image responsive-img full">
                    <img src = { images[0] } alt="Post picture" />
                </div>
                <div className="__image responsive-img full">
                    <img src = { images[1] } alt="Post picture" />
                </div>
            </div>
